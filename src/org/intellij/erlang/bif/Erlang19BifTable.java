...
public class Erlang19BifTable {
  ...
  static {
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "list_to_port", 1, "String", true));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "list_to_ref", 1, "String", true));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "dist_get_stat", 1, "DistHandle"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "dist_ctrl_input_handler", 2, "DistHandle, InputHandler"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "dist_ctrl_put_data", 2, "DistHandle, Data"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "dist_ctrl_get_data", 1, "DistHandle"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "dist_ctrl_get_data_notification", 1, "DistHandle"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "dist_ctrl_get_opt", 2, "DistHandle, 'get_size'"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "dist_ctrl_set_opt", 3, "DistHandle, 'get_size', Value"));
  ...
  private static void putGeneratedInfo() {
    ...
    bifMap.putValue("", new ErlangBifDescriptor("", ErlangBifTable.MODULE_INFO, 0, "", true));
    bifMap.putValue("", new ErlangBifDescriptor("", ErlangBifTable.MODULE_INFO, 1, "Key", true));
  }
